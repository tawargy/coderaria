...
export const listPostHandler: ExpressHandlerUser<ListPostReq, ListPostRes> = async (req, res) => {
...
export const creatPostHandler: ExpressHandlerUser<CreatePostReq, CreatePostRes> = async (
  req,
  res
) => {
  if (!req.body.title || req.body.title === '' || !req.body.url || req.body.url === '')
...
export const getPostHandler: ParamExpressHandler<GetIdParams, GetPostReq, GetPostRes> = async (
  req,
  res
) => {
